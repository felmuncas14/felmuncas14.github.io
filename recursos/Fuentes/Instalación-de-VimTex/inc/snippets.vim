...
" Inicio de mis modificaciones al archivo por defecto

" Inicio de la configuración de UltiSnips

" Usar el tabulador para expandir los «snippet»
let g:UltiSnipsExpandTrigger       = '<Tab>'
" Usar el tabulador para moverse entre las sugerencias
let g:UltiSnipsJumpForwardTrigger  = '<Tab>'
" Usar «Shift + Tabulador» para moverse hacia atrás en las sugerencias
let g:UltiSnipsJumpBackwardTrigger = '<S-Tab>'

" Pongo la carpeta en la que se encuentran los «snippets», si no
" la especifico, UltiSnips busca carpetas con nombre UltiSnips
" en toda la carpeta de runtimepath de vim (por defecto es
" $HOME/.vim).
"
" El . entre $HOME y el string es el operador de concatenación
" en Vimscript.
let g:UltiSnipsSnippetDirectories=[$HOME.'/.vim/UltiSnips']

" Fin de la configuración de UltiSnips

" Fin de mis modificaciones al archivo por defecto
"
